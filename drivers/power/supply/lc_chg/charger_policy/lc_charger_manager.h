...
#define TYPICAL_CAPACITY                   7600000

#define _TO_STR(x) #x
#define TO_STR(x) _TO_STR(x)
#if IS_ENABLED(CONFIG_XM_CHG_ANIMATION)
#define PROJECT_NAME                        BN70
#define TYPICAL_CAPACITY_MAH                7600
#define INPUT_POWER_LIMIT                   15
...
#define REVERSE_CHARGE_MIN_CURR         -2000000
...
struct charger_manager {
	...
	struct delayed_work apsd_detect_work;
	...
	bool ignore_upload_endurance_pro;
	bool ignore_upload_navigation;
#endif
#if IS_ENABLED(CONFIG_XIAOMI_SMART_CHG)
	...
	bool reverse_quick_charge_support;
	bool force_source;
