...
#ifdef CONFIG_SUPPORT_NUVOLTA_PDPHY
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE, 24, 26),
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE_30, 27, 28),
#else
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE, 24, 30),
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SENDER_RESPONSE_30, 27, 33),
#endif /* CONFIG_SUPPORT_NUVOLTA_PDPHY */
...
DECL_TCPC_TIMEOUT_RANGE(PD_TIMER_SRC_RECOVER, 660, 800),
...
#ifdef CONFIG_SUPPORT_NUVOLTA_PDPHY
/* TYPEC_TRY_TIMER */
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TRY_TIMER_DRP_TRY, 75, 120),
/* TYPEC_DEBOUNCE_TIMER */
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TIMER_CCDEBOUNCE, 100, 180),
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TIMER_PDDEBOUNCE, 10, 10),
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TIMER_TRYCCDEBOUNCE, 10, 15),
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TIMER_SRCDISCONNECT, 0, 5),
DECL_TCPC_TIMEOUT_RANGE(TYPEC_TIMER_DRP_SRC_TOGGLE, 50, 100),
DECL_TCPC_TIMEOUT(TYPEC_TIMER_GET_SRC_HDR, 1),
// DECL_TCPC_TIMEOUT(TYPEC_TIMER_RETRY_TIME, 3),
#else
...
void tcpc_enable_timer(struct tcpc_device *tcpc, uint32_t timer_id)
{
    ...
    if (pd_check_rev30(&tcpc->pd_port) && 
                timer_id == PD_TIMER_SENDER_RESPONSE) {
