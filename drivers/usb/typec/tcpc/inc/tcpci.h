...
#define NUVOLTA_PD_VER          0X3211
#define NU6601_DID_A            0x6601
#define NU6601_VID              0x37A0
#define NU6601_PID              0x6601
#define NU6601_DID              0x00A3
...
extern int tcpci_alert_fake_power_status_changed(struct tcpc_device *tcpc);
extern int tcpci_get_fake_power_status(struct tcpc_device *tcpc, uint16_t *pw_status);
...
int tcpci_pd_enable(struct tcpc_device *tcpc, int enable);
...
int tcpci_retry(struct tcpc_device *tcpc);//uu635
