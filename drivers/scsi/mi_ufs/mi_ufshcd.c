...
#include "mi_unipro.h"
#include "mi_ufs-sysfs.h"
#include "mi_ufs-debugfs.h"
#include "mi_ufs-fault-injection.h"
#include "mi_ufs_bsg.h"
#include "mi_ufshcd-crypto.h"
#include "mi_ufshpb.h"
...
#ifdef CONFIG_MI_UFS_FFU
#include "mi_ffu/ufs_ffu.h"
#endif
...
#if IS_ENABLED(CONFIG_FACTORY_BUILD) && IS_ENABLED(CONFIG_UFS_WB_CHECK)
	mi_check_wb(hba);
#endif
...
#if defined(CONFIG_MI_MEMORY_CLD)
	ufscld_on_idle(hba);
#endif
}
...
extern void ufscld_init(struct ufs_hba *hba);
/**
...
#if IS_ENABLED(CONFIG_MI_UFS_FFU)
	ufs_ffu();
#endif
