...
#include "XBSTOR_UFS2_2_0316.h"
#include "HG_HBL190_1001.h"
...
static struct fw_update_checklist need_update_k[] = {
	...
	{"XBSTOR", "XBUSC1A17A8TG1", "0306", "0316", (uint64_t)XBSTOR_UFS2_2_0316, sizeof(XBSTOR_UFS2_2_0316)},
	{"HG", "HBL19064G0CHBC", "0105", "1001",(uint64_t)HG_HBL190_1001, sizeof(HG_HBL190_1001)},
};
...
{
	/*
	 * lun = 2 is only for MTK lu configuration
	 * lun 0/1 are boot lu while lun 2 is normal lu
	 */
	int lun = 2;
